...
- $W_0(z)$ (Principal Branch): Analytic at $0$ with $W_0(0)=0$. The branch cut lies along the negative real axis $(-\infty, -1/e]$. Its range is the region of the $w$-plane containing the real interval $(-1, \infty)$ and bounded by the transcendental curve satisfying $|w e^w| = |-1/e|$.
