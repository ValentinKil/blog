...
*This post is the written version of a talk I gave in November 2025 for the Third Year Graduate Talks at the Department of Statistics, University of Oxford.*
...
- $W_0(z)$ (Principal Branch): Analytic at $0$ with $W_0(0)=0$. The branch cut lies along the negative real axis $(-\infty, -1/e]$. Its range is the region of the $w$-plane containing the real interval $(-1, \infty)$ and bounded by the transcendental curve satisfying $\mid w e^w\mid = \mid-1/e\mid$.
